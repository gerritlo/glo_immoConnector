 ...
 */
array_insert($GLOBALS['BE_MOD']['system'], null, array
(
...
(
	...
	(
		...
		'immoConnectorImmoDetail' => 'ModuleImmoConnectorImmoDetail',
		'immoConnectorImmoRandom' => 'ModuleImmoConnectorImmoRandom',
	)
));
...
$GLOBALS['TL_PURGE']['folders']['immoConnector'] = array(
		...
		'affected' => array(GloImmoConnector\ImmoConnector::CACHE_DIRECTORY)
	);
